 ...
 * @author radhika
 */
public class oderses12 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       // session.setAttribute("n1111",n111);
       
     //   session.setAttribute("n7777",n777);
           ...
           int mintt=Integer.parseInt(n777); ////mintt==minimum toatal
           ...
           if((n111.equals("Chicken Soup")&&(mintt>=200))||(n111.equals("Onion Bhaji")&&(mintt>=200))||(n111.equals("Keema Kofte")&&(mintt>=200))){
            ...
            out.println("<head>");
            out.println("<body>");  
                       out.println("<form action='disount11'>");
          ...
          out.println("</table>");
           ...
           out.println("<tr>");out.println("<td>"); out.println("<h2><a href='bill1.jsp'> Make payment</a></h2>"); out.println("</td>");out.println("</tr>");
          out.println("<tr>"); out.println("<td>"); out.println("<h2><a href='cancel.jsp'> cancel order</a></h2>"); out.println("</td>");out.println("</tr>");
           ...
           out.println("</html>");
             ...
             session.setAttribute("ite",n111);
              session.setAttribute("n3333",n333);////////////
        session.setAttribute("n4444",n444);
        session.setAttribute("n5555",n555);
        session.setAttribute("n6666",n666);///////////////
           session.setAttribute("tt", n777);
            session.setAttribute("n8888",n888);///////////
       session.setAttribute("n9999",n999);
       session.setAttribute("n1000",n100);////////////////
